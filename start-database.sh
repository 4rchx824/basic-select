...
DB_CONTAINER_NAME="drop-down-list-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=drop-down-list -d -p 5432:5432 docker.io/postgres
